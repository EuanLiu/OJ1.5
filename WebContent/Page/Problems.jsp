...
<html>
	<head>
	    ...
	    <link rel="icon" href="https://cdn.luogu.com.cn/upload/image_hosting/0r6l41a4.png">
	...
	<body>
		...
		<div class="container clearfix">
			<h3 class="tl-subnav-title">题库</h3>
			<ul class="tl-subnav-menu">
				<li class="active"><a href="Problems.jsp">所有题目</a></li>
			</ul>
		</div>
		</nav>
		
		<form action="<%=basePath %>problemshow" method="post">
			<div style="margin-left:1080px;">
				<input type="text" name="search" aria-controls="problemset">
				...
				<tbody>
					<tr role="row" class="odd">
						...
						<td>
							<table align="center">
								<tr>
									<td>A.${problem.getA()}</td>
								</tr>
								<tr>
									<td>B.${problem.getB()}</td>
								</tr>
								<tr>
									<td>C.${problem.getC()}</td>
								</tr>
								<tr>
									<td>D.${problem.getD()}</td>
								</tr>
							</table>
						</td>
					</tr>
